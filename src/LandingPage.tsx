...
const AppMockup: React.FC<{
  ...
  <div
    className={`aspect-[9/18.5] w-72 bg-dark-2 rounded-3xl border-4 border-dark-3 p-2 shadow-2xl shadow-brand-purple/20 ${className}`}
  >
...
const PreviewNavButton: React.FC<{
  isActive: boolean;
  children: React.ReactNode;
}> = ({ isActive, children }) => (
  <button
    className={`p-1 rounded-full transition-all duration-300 ${
      isActive ? `bg-brand-pink text-white` : "text-gray-500"
    }`}
  >
    {children}
  </button>
...
const PreviewHeader: React.FC<{ activeView: PreviewView }> = ({
  activeView,
}) => (
    ...
    <div className="flex items-center gap-1.5">
      <div className="w-5 h-5">
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <path
            d="M12 6l1.06 2.54L15.5 9.5l-2.54 1.06L12 13l-1.06-2.54L8.5 9.5l2.54-1.06L12 6z"
            fill="white"
          />
        </svg>
      </div>
  ...
  <>
    ...
    <div className="p-1.5 w-full space-y-1.5 overflow-y-auto scrollbar-hide flex-grow">
      ...
      <div className="bg-dark-2 rounded-md p-2 flex flex-col gap-1 border border-dark-3 text-left">
        <div className="flex items-center gap-1.5">
          <img
            src="https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?q=80&w=100"
        ...
        <div>
          <h3 className="text-xs font-bold text-brand-light">
            Stargazing & S'mores Night
          </h3>
          <p className="text-[9px] text-gray-300 mt-0.5 line-clamp-2">
            Let's escape the city lights. I'll bring the telescope and s'mores
            if you bring a cozy blanket...
          </p>
        </div>
        <div className="flex flex-wrap gap-1">
          <div className="text-[8px] font-semibold px-1.5 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
            Outdoors & Adventure
          </div>
          <div className="text-[8px] font-semibold px-1.5 py-0.5 rounded-full bg-sky-500/20 text-sky-400 border border-sky-500/30">
            Relaxing & Casual
          </div>
        </div>
        <div className="mt-1 flex gap-1">
          <button className="flex-1 text-[10px] py-1 rounded-sm font-bold bg-blue-600 text-white">
            I'm Interested!
          </button>
      ...
      <div className="bg-dark-2 rounded-md p-2 flex flex-col gap-1 border border-dark-3 text-left">
        ...
        <div>
          ...
          <p className="text-[9px] text-gray-300 mt-0.5 line-clamp-2">
            Ready for a challenge? Let's battle it out over a game of Catan or
            Ticket to Ride. Loser buys...
          </p>
        </div>
        <div className="mt-1 flex gap-1">
          <button className="flex-1 text-[10px] py-1 rounded-sm font-bold bg-blue-600 text-white">
      ...
      <div className="bg-dark-2 rounded-md p-2 flex flex-col gap-1 border border-dark-3 text-left">
        ...
        <div>
          ...
          <p className="text-[9px] text-gray-300 mt-0.5 line-clamp-2">
            Let's wander through the museum and pretend we're fancy art critics.
            Followed by a walk and ice cream.
          </p>
        </div>
        <div className="mt-1 flex gap-1">
          <button className="flex-1 text-[10px] py-1 rounded-sm font-bold bg-blue-600 text-white">
      ...
      <div className="space-y-3">
        <div>
          ...
          <input
            type="text"
            readOnly
            value="Sunset Picnic in the Park"
            className="w-full bg-dark-3 text-white text-xs p-1.5 rounded-md border border-dark-3 focus:ring-2 focus:ring-brand-pink"
          />
        </div>
        <div>
          <label className="block text-[10px] font-medium text-gray-300 mb-0.5">
          ...
          <div className="flex gap-1">
            <input
              ...
              className="w-full bg-dark-3 text-white text-xs p-1.5 rounded-md border border-dark-3 focus:ring-2 focus:ring-brand-pink"
            />
            <button className="bg-brand-pink text-white text-xs font-semibold px-2 rounded-md flex items-center justify-center gap-0.5">
              <SparklesIcon className="w-3 h-3" />
              Enhance
            </button>
          </div>
        ...
        <div>
          ...
          <textarea
            readOnly
            className="w-full bg-dark-3 text-white text-xs p-1.5 rounded-md h-16 resize-none border border-dark-3 focus:ring-2 focus:ring-brand-pink"
            value="Let's find a perfect spot to watch the sunset with some great food and even better conversation..."
          ></textarea>
        </div>
          ...
          <div>
            ...
            <div className="flex gap-1">
              <input
                ...
                className="w-full bg-dark-3 text-white text-xs p-1.5 rounded-md border border-dark-3 focus:ring-2 focus:ring-brand-pink"
              />
              <button className="relative px-2 bg-cyan-600/50 rounded-md">
        ...
        <button className="w-full bg-gradient-to-r from-brand-pink to-brand-purple text-white text-sm font-bold py-2 rounded-lg">
          Post Date
        </button>
      </div>
    </div>
...
const SwipeDeckPreview: React.FC = () => (
  <>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-2 text-white pointer-events-none space-y-1">
          ...
          <div className="min-h-[16px]">
            <div className="flex items-center gap-1.5">
              ...
              <p className="text-[10px] italic text-cyan-200">
                "Creative & Adventurous"
              </p>
            </div>
          </div>
          <p className="text-[10px] text-light-2 line-clamp-2">
            Graphic designer with a love for all things vintage...
          </p>
          <div className="flex flex-wrap gap-1">
            <span className="bg-white/20 text-white text-[9px] font-semibold px-2 py-0.5 rounded-full">
              Art
            </span>
            <span className="bg-white/20 text-white text-[9px] font-semibold px-2 py-0.5 rounded-full">
              Vintage
          ...
          <div className="pt-1.5 border-t border-white/20">
            ...
            <div className="mt-0.5">
              <p className="text-[10px] text-gray-200 italic line-clamp-2">
                "You both seem to have a creative side..."
              </p>
              <div className="flex items-center gap-2 mt-1">
                <div className="w-full bg-dark-3 rounded-full h-1.5">
                  <div
                    className="bg-gradient-to-r from-cyan-400 to-emerald-500 h-1.5 rounded-full"
                    style={{ width: `82%` }}
                  ></div>
                </div>
    ...
    <div className="w-full flex justify-center items-center gap-3 p-2 flex-shrink-0">
      <button className="bg-white/10 p-2 rounded-full text-amber-400">
        <UndoIcon className="w-4 h-4" />
      </button>
      <button className="bg-white/10 p-2.5 rounded-full text-red-500">
        <XIcon className="w-5 h-5" />
      </button>
      <button className="bg-white/10 p-2 rounded-full text-blue-400">
        <StarIcon className="w-4 h-4" />
      </button>
      <button className="bg-white/10 p-2.5 rounded-full text-green-400">
  ...
  return (
    <div className="bg-dark-1 font-montserrat text-light-1 overflow-x-hidden">
      ...
      <header className="py-4 px-6 md:px-12 flex justify-between items-center">
        ...
        <a
          href="#early-access"
          className="bg-brand-pink text-white font-semibold px-4 py-2 rounded-full text-sm hover:opacity-90 transition-opacity"
        >
          Get Early Access
        </a>
      </header>
      ...
      <section className="relative text-center py-20 md:py-32 px-4 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "radial-gradient(#F91880 1px, transparent 1px)",
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-lg md:text-xl text-gray-300 max-w-xl mx-auto">
            Tired of endless chats that go nowhere? Create-A-Date is the first
            app that puts the date first. Propose an idea, find someone
            interested, and actually meet up.
          </p>
          <form
          ...
          >
            ...
            <button
              type="submit"
              disabled={isSubmitted}
              className="bg-brand-pink text-white font-bold py-3 px-6 rounded-full transition-all duration-300 hover:shadow-glow-pink disabled:bg-gray-500 disabled:shadow-none"
            >
      ...
      <section className="py-20 px-4 bg-dark-1">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">
            An entirely new way to date.
          </h2>
          <p className="text-center text-gray-400 mb-12 max-w-2xl mx-auto">
            We solve the biggest problems in online dating with features
            designed to get you on real, interesting dates.
          </p>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              Instead of just swiping, browse a feed of actual date ideas posted
              by people near you. Show your interest and get chosen.
            </FeatureCard>
            <FeatureCard
              icon={<BrainIcon className="w-6 h-6 text-white" />}
              title="Your AI Wingman"
            >
              Never get stuck for words. Our AI helps you craft the perfect date
              description, generate witty icebreakers, and even suggests replies
              in chat.
            </FeatureCard>
            <FeatureCard
            ...
            >
              Find cool, real-time local events—concerts, markets, workshops—and
              create a date post from them in one tap.
            </FeatureCard>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-3xl font-bold mb-4">
              Plan First. Match Second.
            </h3>
            <p className="text-gray-300 mb-4">
              The "Date Marketplace" is our core feature. It flips the script on
              dating apps. By focusing on a shared activity, you connect with
              people based on genuine, shared interests from the very beginning.
            </p>
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-center gap-2">
                ✓ Filter for intent and initiative.
              </li>
              <li className="flex items-center gap-2">
                ✓ Eliminate the endless "talking stage".
              </li>
              <li className="flex items-center gap-2">
                ✓ Go on dates you're actually excited about.
              </li>
            </ul>
          </div>
      ...
      <section className="py-20 px-4 bg-dark-1">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-gray-300 mb-4">
              Our suite of AI tools is like having a dating coach in your
              pocket. From enhancing your simple date ideas into compelling
              invitations to suggesting clever replies when you're stuck, we
      ...
      <section className="py-20 px-4 bg-dark-2/50">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Enjoy the classic swiping experience, supercharged with AI. Our
              "Vibe Check" gives you instant, AI-generated insights into a
              person's personality and your potential compatibility before you
              even swipe.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-dark-1 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-lg text-gray-300">
            Be the first to experience a dating app that values your time and
            helps you create memories. Sign up now and we'll let you know the
            moment we launch.
          </p>
          <form
            onSubmit={handleEmailSubmit}
      ...
      <footer className="text-center py-6 px-4 bg-dark-2 border-t border-dark-3">
        <p className="text-gray-500 text-sm">
          &copy; {new Date().getFullYear()} Create-A-Date. All rights reserved.
