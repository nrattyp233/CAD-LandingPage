...
const AdventurousIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3 21h18M5 15l4-4 4 4 5-5 4 4"
    />
  </svg>
);
...
export const BADGES: Record<Badge["id"], Badge> = {
  first_date: {
    ...
    description:
      "You posted your first date idea! Way to put yourself out there.",
    icon: FirstDateIcon,
  },
  adventurous: {
    id: "adventurous",
  ...
  prolific_planner: {
    ...
    description:
      "You've posted multiple date ideas. You're a dating visionary!",
